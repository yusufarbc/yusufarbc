...
In the early 1980s, AT&T sought to monetize the UNIX operating system and began marketing the operating system with special licenses. Many people who helped develop the operating system from the day UNIX emerged opposed this decision. Thereupon, the **GNU** project, whose aim was to create a UNIX-like operating system that could be distributed free of charge, was started by **Richard Stallman** and the "Free Software Foundation (FSF — Free Software Foundation)" was established for this project.
