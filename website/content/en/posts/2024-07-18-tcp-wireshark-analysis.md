---
date: '2024-07-18'
description: 'Hello, in this article I will try to explain the TCP protocol and its analysis with Wireshark. --- ### What is TCP? TCP provides connected transport over a connection that begins with a three...'
draft: false
