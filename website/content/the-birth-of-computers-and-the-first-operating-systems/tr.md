...
## İlk Bilgisayarlar ve Donanım Odaklı Dönem

<center><img src="./medium-first-computers.webp" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="İlk Bilgisayarlar"></center>
...
<center><img src="./eniac.webp" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="ENIAC - İlk Genel Amaçlı Elektronik Bilgisayar"></center>
...
<center><img src="./medium-unix.gif" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Unix'in Doğuşu"></center>
...
<center><img src="./unix-creators.jpg" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Ken Thompson ve Dennis Ritchie - Unix ve C Dilinin Yaratıcıları"></center>
...
## Xerox PARC: Modern Arayüzlerin Gerçek Atası
...
<center><img src="./xerox-alto.jpg" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Xerox Alto - Modern GUI'nin Atası"></center>
...
<center><img src="./medium-windows.jpg" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Windows'un Doğuşu"></center>
...
<center><img src="./microsoft-founders.webp" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Bill Gates ve Paul Allen - Microsoft'un Kuruluş Yılları"></center>
...
<center><img src="./ibm-pc.webp" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="IBM PC Model 5150 - Kişisel Bilgisayar Standardını Belirleyen Makine"></center>
...
## Özgür Yazılım Felsefesi ve Linux'un Doğuşu
...
<center><img src="./richard-stallman.webp" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Richard Stallman - Özgür Yazılım Hareketinin Öncüsü"></center>
...
## Çekirdek Mimarileri: Monolitik vs. Mikro Çekirdek

İşletim sistemlerinin kalbi olan çekirdekler (kernel), tasarım felsefelerine göre ikiye ayrılır:

1.  **Monolitik Çekirdek (Linux, MS-DOS):** Tüm temel servisler (sürücüler, dosya sistemi vb.) tek bir büyük çekirdek içinde çalışır. Bu yapı yüksek performans sağlar ancak tek bir hata tüm sistemi çökertebilir.
2.  **Mikro Çekirdek (Minix, QNX):** Çekirdek sadece en temel görevleri (bellek yönetimi gibi) yapar; diğer her şey kullanıcı alanında çalışır. Daha güvenli ve modülerdir ancak sistem çağrılarından dolayı performans kayıpları yaşanabilir.
3.  **Hibrit Çekirdek (Windows NT, macOS/XNU):** Her iki dünyanın avantajlarını birleştirmeyi hedefler.

## Günümüz İşletim Sistemleri

<center><img src="./medium-todays-os.webp" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="Günümüz İşletim Sistemleri"></center>
...
## Mobil İşletim Sistemleri: iOS ve Android Dönemi
...
## İşlemci Mimarilerindeki Değişim: x86'dan ARM'ye

<center><img src="./x86-arm.jpg" style="width: 100%; max-width: 800px; border-radius: 8px;" alt="x86 vs ARM Mimarisi"></center>
...
## Güvenlik ve Sanallaştırma (Hypervisors)
