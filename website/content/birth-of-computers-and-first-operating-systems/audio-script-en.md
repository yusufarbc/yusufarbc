...
Chapter: First Computers and the Hardware-Focused Era

[Image: First Computers]
...
[Image: ENIAC - The First General-Purpose Electronic Computer]
...
Chapter: The Birth of Unix

[Image: The Birth of Unix]
...
[Image: Ken Thompson and Dennis Ritchie - Creators of Unix and the C Language]
...
Chapter: Xerox PARC: The True Ancestor of Modern Interfaces
...
[Image: Xerox Alto - The Ancestor of the Modern GUI]
...
Chapter: The Birth of Windows

[Image: The Birth of Windows]
...
[Image: Bill Gates and Paul Allen - The Early Years of Microsoft]
...
[Image: IBM PC Model 5150 - The Machine That Set the PC Standard]
...
Chapter: Free Software Philosophy and the Birth of Linux
...
[Image: Richard Stallman - Pioneer of the Free Software Movement]
...
Chapter: Kernel Architectures: Monolithic vs. Microkernel

Kernels, the heart of operating systems, are divided into two main design philosophies:

Monolithic Kernel (Linux, MS-DOS): All core services (drivers, filesystem, etc.) run within a single large kernel. This structure provides high performance, but a single error can crash the entire system.
Microkernel (Minix, QNX): The kernel handles only the most basic tasks (like memory management); everything else runs in user space. It is more secure and modular but can suffer from performance losses due to system calls.
Hybrid Kernel (Windows NT, macOS/XNU): Aims to combine the advantages of both worlds.

---

Chapter: Today's Operating Systems
...
Chapter: Mobile Operating Systems: The Era of iOS and Android
...
Chapter: The Shift in Processor Architectures: From x86 to ARM

[Image: x86 vs ARM Architecture]
...
Chapter: Security and Virtualization (Hypervisors)
...
Chapter: Cloud, Containers, and the Future
