---
date: '2024-07-18'
description: 'Merhaba bu yazımda TCP protokolünü ve Wireshark ile analizini anlatmaya çalışacağım. --- ### TCP Nedir? TCP, iki cihaz arasında üçlü el sıkışma ile başlayan bir bağlantı üzerinden bağlantılı ...'
draft: false
