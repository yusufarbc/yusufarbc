---
date: '2025-08-19'
description: SOC (Security Operations Center — Güvenlik Operasyon Merkezi) ve NOC
  (Network Operations Center — Ağ Operasyon Merkezi) birbirini tamamlayan ancak farklı
  odaklara sahip iki merkezi yapıdır. NOC, bir kuruluşun ağ altyapısını, sistem performansını
  ve h...
draft: false
