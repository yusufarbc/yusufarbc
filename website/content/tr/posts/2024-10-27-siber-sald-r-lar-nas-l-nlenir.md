...
#### Güvenlik Açığı Testi (Vulnerability Testing)
...
#### Uygulama Güvenlik Duvarları (Application Firewalls)
...
#### Bütünleşik Tehdit Yönetimi (Unified Threat Management — UTM)
...
### 12. Kullanıcı Erişimini Kontrol Etme
...
#### Kimlik Doğrulama, Yetkilendirme ve Hesap (Authentication, Authorization, and Accounting — AAA)
...
#### kullanıcının ne olduğu (What the User Is)
...
#### Kullanıcının Bildikleri (What the User Knows)
...
#### Kullanıcının Sahip Oldukları (What the User Has)
...
#### Kullanıcının Kimliği Doğrulandı, Ancak Yetkilendirildi mi?
