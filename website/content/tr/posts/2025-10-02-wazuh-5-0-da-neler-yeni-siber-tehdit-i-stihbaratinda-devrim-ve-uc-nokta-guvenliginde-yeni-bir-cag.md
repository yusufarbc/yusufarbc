---
date: '2025-10-02'
description: Wazuh, Host-Based Intrusion Detection System (HIDS) mirasını modern siber
  güvenlik ihtiyaçlarıyla birleştirerek, Güvenlik Bilgi ve Olay Yönetimi (SIEM) ve
  Genişletilmiş Tespit ve Yanıt (XDR) yeteneklerini tek bir platformda topladı. Wazuh
  5.0, bu bir...
draft: false
