...
**Blockchain**(blockchain) is an ever-growing list of [records](https://en.wikipedia.org/wiki/Record_%28computer_science%29 "en:Record (computer science)") blocks, linked and secured using [cryptography](https://tr.wikipedia.org/wiki/Cryptography "Cryptography").
...
* Tezos is a blockchain project that governs itself through the vote of token holders. [Bitcoin](https://tr.wikipedia.org/wiki/Bitcoin "Bitcoin") implements the blockchain as a cryptocurrency and payment system. The Ethereum blockchain added a smart contract system on top of a blockchain. The Tezos blockchain will add an autonomy system — a decentralized code Development function on top of both the bitcoin and Ethereum blockchains.
